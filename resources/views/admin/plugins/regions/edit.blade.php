...
@section('title')
    @unless(empty($editRegion))
        @foreach($editRegion as $region)
            Edit {{ $region->name }}
        @endforeach
    @endunless
@endsection
        ...
        @foreach($editRegion as $region)
            ...
            <div class="panel panel-default primary-container">
                <div class="panel-heading">
                    <i class="ti-world"></i> {{ $region->name }}
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-9">
                            <strong>ID:</strong> {{ $region->id }} <i class="ti-shift-right-alt"></i> <strong>Created
                                At:</strong> {{ $region->created_at->format('M d, Y - g:i:s A') }} <i
                                    class="ti-shift-right-alt"></i> <strong>Updated
                                At:</strong> {{ $region->updated_at->format('M d, Y - g:i:s A') }} <i
                                    class="ti-shift-right-alt"></i> <strong>Created
                                By:</strong> {{ $region->createdBy->name }} <i class="ti-shift-right-alt"></i> <strong>Updated
                                By:</strong> {{ $region->updatedBy->name }}
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Delete: {{ $region->name }}</h4>
                        </div>
            ...
            <div class="panel panel-default primary-container">
                <div class="panel-heading">Edit: {{ $region->name }} @if($region->is_active === 1)
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.regions.update', ['id' => $region->id]) }}" method="post"
                          id="regionEdit">

                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name">Market Name</label>
                            <input type="text" class="form-control" id="name" name="name"
                                   value="{{ old('name') ?: $region->name }}" placeholder="Market Name"
                                   onkeyup="getName()">
                        ...
                        <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="slug" name="slug"
                                   value="{{ old('slug') ?: $region->slug }}" placeholder="URL Slug">
                        ...
                        <div class="form-group{{ $errors->has('region_contents_top') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="region_contents_top" id="region_contents_top"
                                      rows="3">{{ old('region_contents_top') ?: $region->region_contents_top }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('region_contents') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="region_contents" id="region_contents"
                                      rows="3">{{ old('region_contents') ?: $region->region_contents }}</textarea>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Markets Meta</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group{{ $errors->has('seo_title') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="seo_title" name="seo_title"
                                           value="{{ old('seo_title') ?: $region->seo_title }}" placeholder="SEO Title">
                                ...
                                <div class="form-group{{ $errors->has('seo_description') ? ' has-error' : '' }}">
                                    ...
                                    <textarea class="form-control" name="seo_description" id="seo_description"
                                              rows="3">{{ old('seo_description') ?: $region->seo_description }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('seo_keywords') ? ' has-error' : '' }}">
                                    ...
                                    <textarea class="form-control" name="seo_keywords" id="seo_keywords"
                                              rows="3">{{ old('seo_keywords') ?: $region->seo_keywords }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-success" form="regionEdit"><i class="ti-save"></i>
                                    Save Changes
                                </button>
                            </div>
                        </div>
