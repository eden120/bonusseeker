...
@section('title')
    @unless(empty($editGameCategory))
        @foreach($editGameCategory as $game_category)
            Edit {{ $game_category->name }} - Game Categories
        @endforeach
    @endunless
@endsection
        ...
        @foreach($editGameCategory as $game_category)
            ...
            <div class="panel panel-default primary-container">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-9">
                            <strong>ID:</strong> {{ $game_category->id }} <i class="ti-shift-right-alt"></i> <strong>Created
                                At:</strong> {{ $game_category->created_at->format('M d, Y - g:i:s A') }} <i
                                    class="ti-shift-right-alt"></i> <strong>Updated
                                At:</strong> {{ $game_category->updated_at->format('M d, Y - g:i:s A') }}
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Delete: {{ $game_category->name }}</h4>
                        </div>
                        <div class="modal-body">
                            <strong>Are you sure?</strong> This action is irreversible!
                        </div>
                        <div class="modal-footer">
                            <form action="{{ route('admin.game-categories.destroy', ['id' => $game_category->id]) }}"
            ...
            <div class="panel panel-default primary-container">
                <div class="panel-heading">Edit: {{ $game_category->name }} @if($game_category->is_active === 1)
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route('admin.game-categories.update', ['id' => $game_category->id]) }}"
                          method="post"
                          id="GameCategoryEdit">
                        ...
                        <div class="row">
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} col-md-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                       value="{{ old('name') ?: $game_category->name }}"
...
<strong>{{ $errors->first('name') }}</strong>
                            ...
                            <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }} col-md-6">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug"
                                       value="{{ old('slug') ?: $game_category->slug }}" placeholder="URL Slug"
...
<strong>{{ $errors->first('slug') }}</strong>
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} col-md-6">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="2"
                                          maxlength="255"
                                          data-max="255">{{ old('description') ?: $game_category->description }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('seo_title') ? ' has-error' : '' }} col-md-6">
                                ...
                                <input type="text" class="form-control" id="seo_title" name="seo_title"
                                       value="{{ old('seo_title') ?: $game_category->seo_title }}"
                        ...
                        <div class="row">
                            <div class="form-group{{ $errors->has('seo_description') ? ' has-error' : '' }} col-md-6">
                                ...
                                <textarea class="form-control" name="seo_description" id="seo_description" rows="2"
                                          maxlength="255"
                                          data-max="255">{{ old('seo_description') ?: $game_category->seo_description }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('seo_keywords') ? ' has-error' : '' }} col-md-6">
                                ...
                                <textarea class="form-control" name="seo_keywords" id="seo_keywords" rows="2"
                                          maxlength="255"
                                          data-max="255">{{ old('seo_keywords') ?: $game_category->seo_keywords }}</textarea>
