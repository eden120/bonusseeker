            ...
            <form action="{{ route('admin.games.store') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }} col-md-6">
                        ...
                        <select id="category_id" name="category_id" class="form-control selectpicker"
                ...
                <div class="row">
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} col-md-6">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}"
                               placeholder="Game Name" onkeyup="getName()" maxlength="255" data-max="255">
                ...
                <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="url" name="url" value="{{ old('url') }}"
                           placeholder="Game Play URL" maxlength="1024" data-max="1024">
                    <p class="help-block char-max-alert"></p>
                ...
                <div class="form-group{{ $errors->has('seo_description') ? ' has-error' : '' }}">
                    ...
                    <textarea class="form-control" name="seo_description" id="seo_description" rows="3" maxlength="255"
                              data-max="255">{{ old('seo_description') }}</textarea>
                ...
                <div class="form-group{{ $errors->has('seo_keywords') ? ' has-error' : '' }}">
                    ...
                    <textarea class="form-control" name="seo_keywords" id="seo_keywords" rows="3" maxlength="255"
                ...
                <button type="submit" class="btn btn-success" form="createGame"><i class="ti-plus"></i> Create
                    Game
                </button>
