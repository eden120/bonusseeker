...
@section('title', 'All Old Pages')

@section('content')
    <div class="panel panel-default primary-container">
        <div class="panel-heading"><i class="ti-write"></i> All Old Pages</div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('admin.old-pages.index') }}" class="btn btn-primary"><i class="ti-write"></i> All
                        Pages</a>

                    <a href="{{ route('admin.old-pages.create') }}" class="btn btn-success"><i class="ti-write"></i> Add
                        New</a>
                </div>

                <div class="col-md-6">
                    <div class="form-group pull-right">
                        <input type="text" class="search form-control" placeholder="Search Old Pages...">
                    </div>
                    ...
                    @foreach($old_pages as $page)
                        <tr>
                            ...
                            <td class="text-center"><a
                                        href="{{ route('admin.old-pages.edit', ['slug' => $page->slug]) }}">{{ $page->name }}</a>
                            </td>

                            <td class="text-center">{{ \Carbon\Carbon::parse($page->updated_at)->diffForHumans() }}</td>

                            <td class="text-center" style="width: 15%;">
                                <a href="{{ route('front-end.show-parent-post', ['region' => $page->slug]) }}"
                                   class="btn btn-success" target="_blank"><i class="ti-world"></i></a>

                                <a href="{{ route('admin.old-pages.edit', ['slug' => $page->slug]) }}"
            ...
            {{-- Pagination --}}
            {{ $old_pages->links('vendor/pagination/bootstrap-4') }}
