            ...
            <body>
                <div id="top">
                    <nav>
                        ...
                        -
                        <span>
                            <xsl:value-of select="sm:urlset/sm:url/sm:loc"/>
                        </span>
                        -
                        <span>
                            <xsl:choose>
                                <xsl:when test="sm:sitemapindex">
                                    Total sitemap files listed in this index:
                                    <xsl:value-of select="count(sm:sitemapindex/sm:sitemap)"/>
                                </xsl:when>
                                <xsl:otherwise>
                                    Total URLs in this sitemap file:
                ...
                <div id="footer">Total URLs in this sitemap file:
                    <xsl:value-of select="count(sm:urlset/sm:url)"/> | Thanks to
