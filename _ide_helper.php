 ...
 * Generated for Laravel 5.4.36 on 2018-04-11 15:22:09.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Log {
        ...
        {
            \Bugsnag\BugsnagLaravel\MultiLogger::useFiles($path, $level);
        }
        ...
        {
            \Bugsnag\BugsnagLaravel\MultiLogger::useDailyFiles($path, $days, $level);
        }
        ...
        {
            return \Bugsnag\BugsnagLaravel\MultiLogger::getMonolog();
        }
        ...
        {
            \Bugsnag\BugsnagLaravel\MultiLogger::log($level, $message, $context);
        }
        ...
        public static function getEventDispatcher()
        {
            return \Bugsnag\BugsnagLaravel\MultiLogger::getEventDispatcher();
        }
        ...
        {
            \Bugsnag\BugsnagLaravel\MultiLogger::setEventDispatcher($dispatcher);
        }
        ...
        public static function listen($callback)
        {
            \Bugsnag\BugsnagLaravel\MultiLogger::listen($callback);
        }
    ...
    class Route {
         ...
         * @static 
         */ 
        public static function paginate($uri, $action)
        {
            return \Illuminate\Routing\Router::paginate($uri, $action);
        }
...
namespace Folklore\Image\Facades { 
    ...
    class Image {
         ...
         * @static 
         */ 
        public static function proxy($path, $config = array())
        {
            return \Folklore\Image\ImageManager::proxy($path, $config);
        }
         ...
         * @static 
         */ 
        public static function pattern($parameter = null, $pattern = null)
        {
            return \Folklore\Image\ImageManager::pattern($parameter, $pattern);
        }
        ...
        {
            return \Folklore\Image\ImageManager::getRealPath($path);
        }
         ...
         * @static 
         */ 
        public static function getMimeFromFormat($format)
        {
            return \Folklore\Image\ImageManager::getMimeFromFormat($format);
        }
...
namespace Bugsnag\BugsnagLaravel\Facades { 
    ...
    class Bugsnag {
        ...
        {
            return \Bugsnag\Client::getSessionTracker();
        }
...
namespace EmailChecker\Laravel { 
    ...
    class EmailCheckerFacade {
        ...
        {
            return \EmailChecker\EmailChecker::isValid($email);
        }
...
namespace Spatie\PaginateRoute { 
    ...
    class PaginateRouteFacade {
        ...
        {
            return \Spatie\PaginateRoute\PaginateRoute::currentPage();
        }
        ...
        {
            return \Spatie\PaginateRoute\PaginateRoute::isCurrentPage($page);
        }
         ...
         * @static 
         */ 
        public static function nextPage($paginator)
        {
            return \Spatie\PaginateRoute\PaginateRoute::nextPage($paginator);
        }
         ...
         * @static 
         */ 
        public static function hasNextPage($paginator)
        {
            return \Spatie\PaginateRoute\PaginateRoute::hasNextPage($paginator);
        }
         ...
         * @static 
         */ 
        public static function nextPageUrl($paginator)
        {
            return \Spatie\PaginateRoute\PaginateRoute::nextPageUrl($paginator);
        }
        ...
        {
            return \Spatie\PaginateRoute\PaginateRoute::previousPage();
        }
         ...
         * @static 
         */ 
        public static function hasPreviousPage()
        {
            return \Spatie\PaginateRoute\PaginateRoute::hasPreviousPage();
        }
         ...
         * @static 
         */ 
        public static function previousPageUrl($full = false)
        {
            return \Spatie\PaginateRoute\PaginateRoute::previousPageUrl($full);
        }
         ...
         * @static 
         */ 
        public static function allUrls($paginator, $full = false)
        {
            return \Spatie\PaginateRoute\PaginateRoute::allUrls($paginator, $full);
        }
         ...
         * @static 
         */ 
        public static function renderPageList($paginator, $full = false, $class = null, $additionalLinks = false)
        {
            return \Spatie\PaginateRoute\PaginateRoute::renderPageList($paginator, $full, $class, $additionalLinks);
        }
         ...
         * @static 
         */ 
        public static function renderRelLinks($paginator, $full = false)
        {
            return \Spatie\PaginateRoute\PaginateRoute::renderRelLinks($paginator, $full);
        }
         ...
         * @static 
         */ 
        public static function renderHtml($paginator, $full = false)
        {
            return \Spatie\PaginateRoute\PaginateRoute::renderHtml($paginator, $full);
        }
         ...
         * @static 
         */ 
        public static function pageUrl($page, $full = false)
        {
            return \Spatie\PaginateRoute\PaginateRoute::pageUrl($page, $full);
        }
         ...
         * @static 
         */ 
        public static function addPageQuery($url, $page, $full = false)
        {
            return \Spatie\PaginateRoute\PaginateRoute::addPageQuery($url, $page, $full);
        }
        ...
        {
            return \Spatie\PaginateRoute\PaginateRoute::registerMacros();
        }
...
namespace Publiux\laravelcdn\Facades { 
    ...
    class CdnFacadeAccessor {
        ...
        {
            return \Publiux\laravelcdn\CdnFacade::asset($path);
        }
        ...
        {
            return \Publiux\laravelcdn\CdnFacade::mix($path);
        }
         ...
         * @static 
         */ 
        public static function elixir($path)
        {
            return \Publiux\laravelcdn\CdnFacade::elixir($path);
        }
        ...
        public static function path($path)
        {
            return \Publiux\laravelcdn\CdnFacade::path($path);
        }
...
namespace  { 
    ...
    class randomString extends \App\Services\randomString {}
    ...
    class BS extends \App\Services\BS {}

    class EmailChecker extends \EmailChecker\Laravel\EmailCheckerFacade {}

    class PaginateRoute extends \Spatie\PaginateRoute\PaginateRouteFacade {}
